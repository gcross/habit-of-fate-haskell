...
test_habit = Habit "name" (Difficulty Low) (Importance Medium) Indefinite [] Nothing (KeepNumberOfDays 3)
test_habit_2 = Habit "test" (Difficulty Medium) (Importance VeryHigh) Indefinite [] Nothing (KeepNumberOfDays 3)
